...
export function setMockProduct(product: Product)//replace or append product
{
    const index = MockProducts.findIndex((p) => { return p.id === product.id })
    if (index === -1) {
        ...
        return "prodcut has been updated";
    }
}
